...
//		fs.writeFileSync("adreseSaKoordinatama.json",JSON.stringify(adrese),{encoding:"utf8"})
  ...
  "1872346"
    ...
    var sifraKonstatacija 	=	["80.04.01.002","80.04.01.005"];
		...
		var previousDates = getDatesBetween("2026-06-16", "2026-06-22");
		var previousDates2 = getDatesBetween("2026-06-16", "2026-06-22");
   	var query = getDateRangeQuery("2026-06-16", "2026-06-22");
